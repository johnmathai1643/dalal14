<?php
include_once("/home/dalal/public_html/dalal14/main/facebooklogin/fbaccess1.php");
...
if($access_token!=NULL) {
     ...
     if($result) {
       session_destroy();
       echo ("You have successfully logged out ! Click <a href=\"http://www.facebook.com/logout.php?next=http://www.pragyan.org/~dalal/dalal14/main/facebooklogin/new.php&access_token=" . $access_token . "\">here</a> to goto your facebook account.");
       //  session_destroy();
