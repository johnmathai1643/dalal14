...
if((thesellid1<1) || (noofsharesforsell<1) || (pricepershare<5))
			...
			if(!((!isNaN(thesellid1)) && (!isNaN(noofsharesforsell)) && (!isNaN(pricepershare))))
					...
					$("#sellmessage").html("Sell query queued :please be patient; check notifications; ").show().fadeOut(4000);



					/*Hiding the button*/
					$(".sellbutton1").addClass("disabled");
					...
					setTimeout(function () {
						$(".sellbutton1").removeClass("disabled");
				        }, 5000);
					return false;
				});
		}
	...
	//Function For Buy Query
		...
		{	
			...
			if(!((!isNaN(thebuyid1)) && (!isNaN(noofsharestobuy)) && (!isNaN(pricepershare))))
					...
					/*Hiding the button*/
					$(".buybutton1").addClass("disabled");
					$("#buymessage").html("buy query queued :please be patient; check notifications; ").show().fadeOut(4000);
					...
					/*Displaying the button*/
					setTimeout(function () {
						$(".buybutton1").removeClass("disabled");
				        }, 5000);
...
if((thetradeid1<1) || (noofsharestotrade<1))
			...
			if(!((!isNaN(thetradeid1)) && (!isNaN(noofsharestotrade))))
					...
					$("#trademessage").html("Trade query queued :please be patient; check notifications; ").show().fadeOut(4000);


				/*Hiding the button*/
					$(".tradebutton1").addClass("disabled");
					...
					/*Displaying the button*/
					setTimeout(function () {
						$(".tradebutton1").removeClass("disabled");
				        }, 5000);
					return false;
				});
		}
	...
	function redeemquery()
			...
			$(".redeembutton12").click(function()
				{
					...
					$.post(urlphp,{action:"redeem", code:thebankid1 },function(returndata){
						var returndata1=JSON.parse(returndata);
							...
							$("#redeemmessage").html("Redeem Success !").show().fadeOut(4000);
							return ;
		...
		{$("#mormessage1").html("processing  please wait").show().fadeOut(20000);
			...
			if(!(!isNaN(themid1)) && (!isNaN(noofshares)))
					...
					$("#mormessage1").html("Mortgage query queued :please be patient; check notifications; ").show().fadeOut(4000);



				/*Hiding the button*/
					$(".mybuton1").addClass("disabled");
		...
		$("#thesharelistdiv11").html(thestringis);
			...
			function updatemyshares()
			{
					...
					for( i=0;i<regularvariable.sharedetails.length;i++)
					{
						...
						if(regularvariable.sharedetails[i].sharesinmarket>0)
							{
								buybutton="<button class='btn btn-primary buy1' type='button' id='"+b_theidis+"' href='#buymodal' data-toggle='modal'>Buy</button>";
							}
							else
							{
								buybutton="<button class='btn btn-primary disabled buy1' type='button' id='"+b_theidis+"'>Buy</button>";
							}	
						
						if(regularvariable.sharedetails[i].sharesinexchange>0)
						{
							tradebutton="<button class='btn btn-primary trade1' type='button' id='"+t_theidis+"' href='#trademodal' data-toggle='modal'>Trade</button>";
						}
						else
						{
							tradebutton="<button class='btn btn-primary disabled trade1' type='button' id='"+t_theidis+"'>Trade</button>";
						}	
						
						if(regularvariable.sharedetails[i].shareswithme>0)
							{
							sellbutton="<button class='btn btn-primary sell1' type='button' id='"+s_theidis+"' href='#sellmodal' data-toggle='modal'>Sell</button>";
							}
							else
							{
							sellbutton="<button class='btn btn-primary disabled sell1' type='button' id='"+s_theidis+"'>Sell</button>";
							}
			...
			function updatemarket()
			{
					...
					for( i=0;i<regularvariable.sharedetails.length;i++)
					{
						...
						if(regularvariable.sharedetails[i].sharesinmarket>0)
							{
								buybutton="<button class='btn btn-primary buy11' type='button' id='"+b_theidis+"'href='#buymodal' data-toggle='modal' >Buy</button>";
							}
							else
							{
								buybutton="<button class='btn btn-primary disabled' type='button' id='"+b_theidis+"'>Buy</button>";
							}	
						
						if(regularvariable.sharedetails[i].sharesinexchange>0)
						{
							tradebutton="<button class='btn btn-primary trade11' type='button' id='"+t_theidis+"'href='#trademodal' data-toggle='modal'>Trade</button>";
						}
						else
						{
							tradebutton="<button class='btn btn-primary disabled ' type='button' id='"+t_theidis+"'>Trade</button>";
						}	
						
						if(regularvariable.sharedetails[i].shareswithme>0)
							{
							sellbutton="<button class='btn btn-primary sell11' type='button' id='"+s_theidis+"'href='#sellmodal' data-toggle='modal'>Sell</button>";
							}
							else
							{
							sellbutton="<button class='btn btn-primary disabled' type='button' id='"+s_theidis+"'>Sell</button>";
							}
