...
////////////////////////
    ////thisiswhat iedited
//if($takecounter1==4)$takecounter1++;if($takecounter1==5)$takecounter1++;if($takecounter1==7)$takecounter1++;if($takecounter1==6)$takecounter1++;if($takecounter1==8)$takecounter1++;if($takecounter1==16)$takecounter1++;if($takecounter1==16)$takecounter1++;if($takecounter1==17)$takecounter1++;if($takecounter1==18)$takecounter1++;if($takecou
//thisiswhat iedited
...
///////////////////////////////
//$takecounter1++;if($takecounter1==6)$takecounter1++; if($takecounter1==4)$takecounter1++; if($takecounter1==3)$takecounter1++;
//$takecounter2++;if($takecounter2==6)$takecounter2++; if($takecounter2==4)$takecounter2++;if($takecounter2==3)$takecounter2++;
continue;
}
///////////////////////////////
...
///////////////////////////////
///%%%%%%%%%%%%%%%%%thisiswhatiedited
if($takecounter1==4)$takecounter1++;if($takecounter1==7)$takecounter1++;if($takecounter1==5)$takecounter1++;
//%%%%%%%%%%%%%%%thisiswhatiedited
...
$narray=array();
$ncounter=0;
$getthen=mysql_query("SELECT * FROM `notifications` WHERE `userid`='{$this->userid}' AND `seen`=0 ORDER BY `notid` DESC LIMIT 0,6");
